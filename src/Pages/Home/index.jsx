...
const Home = () => {
  ...
  const starshipsData = useFetchData(`https://swapi.dev/api/starships/?format=json${
    search ? `&search=${search}` : ''
  }`, formatStarships);
  const planetsData = useFetchData(`https://swapi.dev/api/planets/?format=json${
    search ? `&search=${search}` : ''
  }`, formatPlanets);
  const charactersData = useFetchData(`https://swapi.dev/api/people/?format=json${
    search ? `&search=${search}` : ''
  }`, formatCharacters);
